...
- [Settings page](#settings-page-%EF%B8%8F)
- [Dark/Light mode](#darklight-mode-%EF%B8%8F)
...
4. Open the app in your browser by visiting [http://localhost:8080](http://localhost:8080).
